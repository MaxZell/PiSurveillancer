...
const tls_options = {
    ...
    checkServerIdentity: () => { return null; } // Verifies the certificate cert is issued to hostname
}
...
io.on('connection', (socket)=>{
    ...
    socket.on('start', (msg)=>{
        // connect to server
		client = tls.connect(server_port, server_host, tls_options, () => console.log('connected to TLS'))
